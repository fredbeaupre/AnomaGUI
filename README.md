...
For every image displayed, select normal if you think it has a score of 0.70 or above, anormal otherwise. Upon selection, the next image will be displayed. Images will continue appearing until all images in the test set are classified, after which the app will close.
